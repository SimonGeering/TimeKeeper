<template>
  <div id="app">
    <TimeLog msg="Welcome to Your Vue.js + TypeScript App"/>
  </div>
</template>
...
:root {
  ...
  --shadow-light: 20px 20px 50px hsl(255, 36%, 17%, .35), -30px -30px 50px hsl(26, 37%, 96%, .15);
  ...
  --shadow-dark: 20px 20px 50px hsl(255, 36%, 17%, .35), -30px -30px 50px hsl(26, 37%, 26%, .15);
 }
...
.text-small {
  font-size: clamp(.8rem, 0.43409097rem + 1.672727vw, 1.375rem);
